...
struct FormValidationTests {
    ...
    @Test("Valid intention passes validation")
    func testValidIntentionValidation() async throws {
    ...
    @Test("Empty intention fails validation with therapeutic message")
    func testEmptyIntentionValidation() async throws {
        let validation = FormValidation()
    ...
    @Test("Current date passes validation")
    func testCurrentDateValidation() async throws {
        let validation = FormValidation()
    ...
    @Test("Future date fails validation with therapeutic message")
    ...
    @Test("Date within 1 hour future tolerance passes validation")
    func testFutureToleranceValidation() async throws {
        let validation = FormValidation()
    ...
    @Test("Very old date fails validation with therapeutic message")
    func testVeryOldDateValidation() async throws {
        let validation = FormValidation()
    ...
    @Test("Date normalization rounds to nearest 15 minutes")
    ...
    @Test("Date normalization message appears for significant changes")
    func testDateNormalizationMessage() async throws {
        let validation = FormValidation()
        let calendar = Calendar.current
    ...
    @Test("No normalization message for minor changes")
    func testNoNormalizationMessageForMinorChanges() async throws {
        let validation = FormValidation()
        let calendar = Calendar.current
    ...
    @Test("Empty dosage passes validation (optional field)")
    func testEmptyDosageValidation() async throws {
        let validation = FormValidation()
    ...
    @Test("Valid dosage passes validation")
    func testValidDosageValidation() async throws {
        let validation = FormValidation()
    ...
    @Test("Extremely long dosage shows gentle guidance")
    func testLongDosageValidation() async throws {
        let validation = FormValidation()
    ...
    @Test("Valid complete form passes validation")
    func testCompleteFormValidation() async throws {
        let validation = FormValidation()
    ...
    @Test("All error messages use therapeutic tone")
    func testTherapeuticTone() async throws {
        let validation = FormValidation()
